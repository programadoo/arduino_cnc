...
#endif
#ifdef GENERATOR_FILE
extern int avr_flmap;
#else
  int x_avr_flmap;
#define avr_flmap global_options.x_avr_flmap
#endif
#ifdef GENERATOR_FILE
extern int avr_fuse_add;
#else
  int x_avr_fuse_add;
#define avr_fuse_add global_options.x_avr_fuse_add
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int avr_rodata_in_ram;
#else
  int x_avr_rodata_in_ram;
#define avr_rodata_in_ram global_options.x_avr_rodata_in_ram
#endif
#ifdef GENERATOR_FILE
extern int avr_sp8;
#else
...
enum opt_code
{
  ...
  OPT_Waddr_space_convert = 447,             /* -Waddr-space-convert */
  ...
  OPT_Wall = 456,                            /* -Wall */
  OPT_Walloc_size = 457,                     /* -Walloc-size */
  OPT_Walloc_size_larger_than_ = 458,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 459,                     /* -Walloc-zero */
  OPT_Walloca = 460,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 461,            /* -Walloca-larger-than= */
  OPT_Wampersand = 462,                      /* -Wampersand */
  OPT_Wanalyzer_allocation_size = 463,       /* -Wanalyzer-allocation-size */
  OPT_Wanalyzer_deref_before_check = 464,    /* -Wanalyzer-deref-before-check */
  OPT_Wanalyzer_double_fclose = 465,         /* -Wanalyzer-double-fclose */
  OPT_Wanalyzer_double_free = 466,           /* -Wanalyzer-double-free */
  OPT_Wanalyzer_exposure_through_output_file = 467,/* -Wanalyzer-exposure-through-output-file */
  OPT_Wanalyzer_exposure_through_uninit_copy = 468,/* -Wanalyzer-exposure-through-uninit-copy */
  OPT_Wanalyzer_fd_access_mode_mismatch = 469,/* -Wanalyzer-fd-access-mode-mismatch */
  OPT_Wanalyzer_fd_double_close = 470,       /* -Wanalyzer-fd-double-close */
  OPT_Wanalyzer_fd_leak = 471,               /* -Wanalyzer-fd-leak */
  OPT_Wanalyzer_fd_phase_mismatch = 472,     /* -Wanalyzer-fd-phase-mismatch */
  OPT_Wanalyzer_fd_type_mismatch = 473,      /* -Wanalyzer-fd-type-mismatch */
  OPT_Wanalyzer_fd_use_after_close = 474,    /* -Wanalyzer-fd-use-after-close */
  OPT_Wanalyzer_fd_use_without_check = 475,  /* -Wanalyzer-fd-use-without-check */
  OPT_Wanalyzer_file_leak = 476,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 477,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_imprecise_fp_arithmetic = 478,/* -Wanalyzer-imprecise-fp-arithmetic */
  OPT_Wanalyzer_infinite_loop = 479,         /* -Wanalyzer-infinite-loop */
  OPT_Wanalyzer_infinite_recursion = 480,    /* -Wanalyzer-infinite-recursion */
  OPT_Wanalyzer_jump_through_null = 481,     /* -Wanalyzer-jump-through-null */
  OPT_Wanalyzer_malloc_leak = 482,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 483,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 484,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 485,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_out_of_bounds = 486,         /* -Wanalyzer-out-of-bounds */
  OPT_Wanalyzer_overlapping_buffers = 487,   /* -Wanalyzer-overlapping-buffers */
  ...
  OPT_Wanalyzer_symbol_too_complex = 494,    /* -Wanalyzer-symbol-too-complex */
  ...
  OPT_Wanalyzer_undefined_behavior_strtok = 502,/* -Wanalyzer-undefined-behavior-strtok */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 503,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 504,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 505,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 506,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 507,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 508,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 509,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 510,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 511,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 512,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 513,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 514,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 515, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 516,                  /* -Warray-bounds= */
  OPT_Warray_compare = 517,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 518, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 519,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 520,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 521,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 522, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 523,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 524,              /* -Wattribute-warning */
  OPT_Wattributes = 525,                     /* -Wattributes */
  OPT_Wattributes_ = 526,                    /* -Wattributes= */
  OPT_Wbad_function_cast = 527,              /* -Wbad-function-cast */
  /* OPT_Wbidi_chars = 528, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 529,                    /* -Wbidi-chars= */
  OPT_Wbool_compare = 530,                   /* -Wbool-compare */
  OPT_Wbool_operation = 531,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 532,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 533,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 534,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 535, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 536,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 537,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 538,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 539,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 540,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 541,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 542, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 543,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 544,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 545,               /* -Wc++23-extensions */
  OPT_Wc__26_extensions = 546,               /* -Wc++26-extensions */
  /* OPT_Wc__2a_compat = 547, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 548,                 /* -Wc-binding-type */
  OPT_Wc11_c23_compat = 549,                 /* -Wc11-c23-compat */
  /* OPT_Wc11_c2x_compat = 550, */           /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 551,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 552,                 /* -Wc99-c11-compat */
  OPT_Wcalloc_transposed_args = 553,         /* -Wcalloc-transposed-args */
  ...
  OPT_Wcast_user_defined = 561,              /* -Wcast-user-defined */
  /* OPT_Wcatch_value = 562, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 563,                   /* -Wcatch-value= */
  OPT_Wchanges_meaning = 564,                /* -Wchanges-meaning */
  OPT_Wchar_subscripts = 565,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 566,           /* -Wcharacter-truncation */
  OPT_Wchkp = 567,                           /* -Wchkp */
  OPT_Wclass_conversion = 568,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 569,                /* -Wclass-memaccess */
  OPT_Wclobbered = 570,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 571,                /* -Wcomma-subscript */
  OPT_Wcomment = 572,                        /* -Wcomment */
  /* OPT_Wcomments = 573, */                 /* -Wcomments */
  OPT_Wcompare_distinct_pointer_types = 574, /* -Wcompare-distinct-pointer-types */
  OPT_Wcompare_reals = 575,                  /* -Wcompare-reals */
  OPT_Wcomplain_wrong_lang = 576,            /* -Wcomplain-wrong-lang */
  OPT_Wconditionally_supported = 577,        /* -Wconditionally-supported */
  OPT_Wconversion = 578,                     /* -Wconversion */
  OPT_Wconversion_extra = 579,               /* -Wconversion-extra */
  OPT_Wconversion_null = 580,                /* -Wconversion-null */
  OPT_Wcoverage_invalid_line_number = 581,   /* -Wcoverage-invalid-line-number */
  OPT_Wcoverage_mismatch = 582,              /* -Wcoverage-mismatch */
  OPT_Wcoverage_too_many_conditions = 583,   /* -Wcoverage-too-many-conditions */
  OPT_Wcpp = 584,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 585,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 586,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 587,                  /* -Wdangling-else */
  /* OPT_Wdangling_pointer = 588, */         /* -Wdangling-pointer */
  OPT_Wdangling_pointer_ = 589,              /* -Wdangling-pointer= */
  OPT_Wdangling_reference = 590,             /* -Wdangling-reference */
  OPT_Wdate_time = 591,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 592,    /* -Wdeclaration-after-statement */
  OPT_Wdeclaration_missing_parameter_type = 593,/* -Wdeclaration-missing-parameter-type */
  OPT_Wdelete_incomplete = 594,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 595,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 596,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 597,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 598,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 599,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 600,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 601,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdesignated_init = 602,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 603,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 604,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 605,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 606,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 607,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 608,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 609,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 610,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 611,                /* -Wduplicated-cond */
  OPT_Weffc__ = 612,                         /* -Weffc++ */
  OPT_Welaborated_enum_base = 613,           /* -Welaborated-enum-base */
  OPT_Wempty_body = 614,                     /* -Wempty-body */
  OPT_Wendif_labels = 615,                   /* -Wendif-labels */
  OPT_Wenum_compare = 616,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 617,                /* -Wenum-conversion */
  OPT_Wenum_int_mismatch = 618,              /* -Wenum-int-mismatch */
  OPT_Werror = 619,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 620, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 621,                         /* -Werror= */
  OPT_Wexceptions = 622,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 623,           /* -Wexpansion-to-defined */
  OPT_Wextra = 624,                          /* -Wextra */
  OPT_Wextra_semi = 625,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 626,                   /* -Wfatal-errors */
  OPT_Wflex_array_member_not_at_end = 627,   /* -Wflex-array-member-not-at-end */
  OPT_Wfloat_conversion = 628,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 629,                    /* -Wfloat-equal */
  /* OPT_Wformat = 630, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 631,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 632,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 633,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 634,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 635, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 636,               /* -Wformat-overflow= */
  OPT_Wformat_security = 637,                /* -Wformat-security */
  OPT_Wformat_signedness = 638,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 639, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 640,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 641,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 642,             /* -Wformat-zero-length */
  OPT_Wformat_ = 643,                        /* -Wformat= */
  OPT_Wframe_address = 644,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 645,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 646,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 647,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 648,           /* -Wfunction-elimination */
  OPT_Wglobal_module = 649,                  /* -Wglobal-module */
  OPT_Whardened = 650,                       /* -Whardened */
  /* OPT_Whsa = 651, */                      /* -Whsa */
  ...
  OPT_Wmisspelled_isr = 715,                 /* -Wmisspelled-isr */
  ...
  OPT_list = 1956,                           /* -list */
  OPT_mabsdata = 1957,                       /* -mabsdata */
  OPT_maccumulate_args = 1958,               /* -maccumulate-args */
  OPT_mbranch_cost_ = 1959,                  /* -mbranch-cost= */
  OPT_mcall_prologues = 1960,                /* -mcall-prologues */
  OPT_mdeb = 1961,                           /* -mdeb */
  OPT_mdouble_ = 1962,                       /* -mdouble= */
  OPT_mflmap = 1963,                         /* -mflmap */
  OPT_mfract_convert_truncate = 1964,        /* -mfract-convert-truncate */
  /* OPT_mfuse_add = 1965, */                /* -mfuse-add */
  OPT_mfuse_add_ = 1966,                     /* -mfuse-add= */
  OPT_mgas_isr_prologues = 1967,             /* -mgas-isr-prologues */
  OPT_mint8 = 1968,                          /* -mint8 */
  OPT_mlog_ = 1969,                          /* -mlog= */
  OPT_mlong_double_ = 1970,                  /* -mlong-double= */
  OPT_mmain_is_OS_task = 1971,               /* -mmain-is-OS_task */
  OPT_mmcu_ = 1972,                          /* -mmcu= */
  OPT_mn_flash_ = 1973,                      /* -mn-flash= */
  OPT_mno_interrupts = 1974,                 /* -mno-interrupts */
  OPT_morder1 = 1975,                        /* -morder1 */
  OPT_morder2 = 1976,                        /* -morder2 */
  OPT_mpmem_wrap_around = 1977,              /* -mpmem-wrap-around */
  OPT_mrelax = 1978,                         /* -mrelax */
  OPT_mrmw = 1979,                           /* -mrmw */
  OPT_mrodata_in_ram = 1980,                 /* -mrodata-in-ram */
  OPT_mshort_calls = 1981,                   /* -mshort-calls */
  OPT_mskip_bug = 1982,                      /* -mskip-bug */
  OPT_msp8 = 1983,                           /* -msp8 */
  OPT_mstrict_X = 1984,                      /* -mstrict-X */
  OPT_mtiny_stack = 1985,                    /* -mtiny-stack */
  OPT_n = 1986,                              /* -n */
  ...
  OPT_nodevicelib = 1993,                    /* -nodevicelib */
  OPT_nodevicespecs = 1994,                  /* -nodevicespecs */
  ...
  OPT_static_libgm2 = 2040,                  /* -static-libgm2 */
  OPT_static_libgo = 2041,                   /* -static-libgo */
  OPT_static_libhwasan = 2042,               /* -static-libhwasan */
  OPT_static_liblsan = 2043,                 /* -static-liblsan */
  OPT_static_libmpx = 2044,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2045,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2046,               /* -static-libphobos */
  OPT_static_libquadmath = 2047,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2048,               /* -static-libstdc++ */
  OPT_static_libtsan = 2049,                 /* -static-libtsan */
  OPT_static_libubsan = 2050,                /* -static-libubsan */
  OPT_static_pie = 2051,                     /* -static-pie */
  /* OPT_std_c__03 = 2052, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2053, */                /* -std=c++0x */
  OPT_std_c__11 = 2054,                      /* -std=c++11 */
  OPT_std_c__14 = 2055,                      /* -std=c++14 */
  OPT_std_c__17 = 2056,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2057, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2058, */                /* -std=c++1z */
  OPT_std_c__20 = 2059,                      /* -std=c++20 */
  OPT_std_c__23 = 2060,                      /* -std=c++23 */
  OPT_std_c__26 = 2061,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2062, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2063, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2064, */                /* -std=c++2c */
  OPT_std_c__98 = 2065,                      /* -std=c++98 */
  OPT_std_c11 = 2066,                        /* -std=c11 */
  OPT_std_c17 = 2067,                        /* -std=c17 */
  /* OPT_std_c18 = 2068, */                  /* -std=c18 */
  /* OPT_std_c1x = 2069, */                  /* -std=c1x */
  OPT_std_c23 = 2070,                        /* -std=c23 */
  /* OPT_std_c2x = 2071, */                  /* -std=c2x */
  /* OPT_std_c89 = 2072, */                  /* -std=c89 */
  OPT_std_c90 = 2073,                        /* -std=c90 */
  OPT_std_c99 = 2074,                        /* -std=c99 */
  /* OPT_std_c9x = 2075, */                  /* -std=c9x */
  OPT_std_f2003 = 2076,                      /* -std=f2003 */
  OPT_std_f2008 = 2077,                      /* -std=f2008 */
  OPT_std_f2008ts = 2078,                    /* -std=f2008ts */
  OPT_std_f2018 = 2079,                      /* -std=f2018 */
  OPT_std_f2023 = 2080,                      /* -std=f2023 */
  ...
  OPT_std_gnu__26 = 2092,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2093, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2094, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2095, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2096,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2097,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2098,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2099, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2100, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2101,                      /* -std=gnu23 */
  ...
  /* OPT_std_iso9899_2024 = 2114, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2115,                     /* -std=legacy */
  OPT_stdlib_ = 2116,                        /* -stdlib= */
  OPT_symbol_ = 2117,                        /* -symbol= */
  OPT_symbolic = 2118,                       /* -symbolic */
  OPT_t = 2119,                              /* -t */
  OPT_time = 2120,                           /* -time */
  OPT_time_ = 2121,                          /* -time= */
  OPT_traditional = 2122,                    /* -traditional */
  OPT_traditional_cpp = 2123,                /* -traditional-cpp */
  OPT_tree_stats = 2124,                     /* -tree-stats */
  OPT_trigraphs = 2125,                      /* -trigraphs */
  OPT_type_stats = 2126,                     /* -type-stats */
  OPT_u = 2127,                              /* -u */
  OPT_undef = 2128,                          /* -undef */
  OPT_v = 2129,                              /* -v */
  OPT_version = 2130,                        /* -version */
  OPT_w = 2131,                              /* -w */
  OPT_wrapper = 2132,                        /* -wrapper */
  OPT_x = 2133,                              /* -x */
  OPT_z = 2134,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
